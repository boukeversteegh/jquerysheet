...
case 19:/*this.$ = Math.E;*/;
break;
case 20:this.$ = yy.lexer.cellHandlers.fixedCellValue.apply(yy.lexer.cell, new Array($$[$0]));
break;
case 21:this.$ = yy.lexer.cellHandlers.fixedCellRangeValue.apply(yy.lexer.cell, new Array($$[$0-2], $$[$0]));
break;
case 22:this.$ = yy.lexer.cellHandlers.cellValue.apply(yy.lexer.cell, new Array($$[$0]));
break;
case 23:this.$ = yy.lexer.cellHandlers.cellRangeValue.apply(yy.lexer.cell, new Array($$[$0-2], $$[$0]));
break;
case 24:this.$ = yy.lexer.cellHandlers.remoteCellValue.apply(yy.lexer.cell, new Array($$[$0-2], $$[$0]));
break;
case 25:this.$ = yy.lexer.cellHandlers.remoteCellRangeValue.apply(yy.lexer.cell, new Array($$[$0-4], $$[$0-2], $$[$0]));
break;
