...
class Parser
{
	...
	function __construct()
	{
		...
		//parser
		$this->symbols_ = 		json_decode('{"error":2,"cells":3,"EOF":4,"rows":5,"END_OF_LINE":6,"columns":7,"COLUMN":8,"$accept":0,"$end":1}', true);
		$this->terminals_ = 	json_decode('{"2":"error","4":"EOF","6":"END_OF_LINE","8":"COLUMN"}', true);
		$this->productions_ = 	json_decode('[0,[3,2],[3,1],[3,2],[5,1],[5,2],[7,1],[7,2]]', true);
		$this->table = 			json_decode('[{"3":1,"5":2,"6":[1,3],"7":4,"8":[1,5]},{"1":[3],"4":[1,6],"5":7,"6":[1,3],"7":4,"8":[1,5]},{"1":[2,2],"4":[2,2],"6":[2,2],"8":[2,2]},{"1":[2,4],"4":[2,4],"6":[2,4],"8":[2,4]},{"6":[1,8],"8":[1,9]},{"6":[2,6],"8":[2,6]},{"1":[2,1],"4":[2,1],"6":[2,1],"8":[2,1]},{"1":[2,3],"4":[2,3],"6":[2,3],"8":[2,3]},{"1":[2,5],"4":[2,5],"6":[2,5],"8":[2,5]},{"6":[2,7],"8":[2,7]}]', true);
		$this->defaultActions = json_decode('{}', true);
...
case 5:
            ...
            $thisS = (is_array($S[$O-1]) ? $S[$O-1] : array());
            $thisS[] = $S[$O1];
...
break;
case 1:return 'DOUBLE_PARENTHESES';
break;
case 2:return 'SINGLE_PARENTHESES';
break;
case 3:return 6;
break;
case 4:return 'TAB';
