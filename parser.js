...
break;
case 8:this.$ = ($$[$0-3+1-1] * 1) + ($$[$0-3+3-1] * 1);
break;
...
case 18:this.$ = Math.E;
break;
case 19:this.$ = arguments[6].fixedCellValue($$[$0-1+1-1]);
break;
case 20:this.$ = arguments[6].fixedCellRangeValue($$[$0-1+1-1]);
break;
case 21:this.$ = arguments[6].cellValue($$[$0-1+1-1]);
break;
case 22:this.$ = arguments[6].cellRangeValue($$[$0-1+1-1]);
break;
case 23:this.$ = arguments[6].remoteCellValue($$[$0-1+1-1]);
break;
case 24:this.$ = arguments[6].remoteCellRangeValue($$[$0-1+1-1]);
break;
...
lexer.rules = [/^\s+/,/^"(\\["]|[^"])*"/,/^'(\\[']|[^'])*'/,/^\$[A-Za-z]+\$[0-9]+[:]\$[A-Za-z]+\$[0-9]+/,/^\$[A-Za-z]+\$[0-9]+/,/^TABLE[0-9]+[:][A-Za-z]+[0-9]+[:][A-Za-z]+[0-9]+/,/^TABLE[0-9]+[:][A-Za-z]+[0-9]+/,/^[A-Za-z]+[0-9]+[:][A-Za-z]+[0-9]+/,/^[A-Za-z]+[0-9]+/,/^[A-Za-z]+/,/^[0-9]([0-9]?)[-/][0-9]([0-9]?)[-/][0-9]([0-9]?)([0-9]?)([0-9]?)/,/^[0-9]+[%]/,/^[0-9]+(\.[0-9]+)?/,/^\$/,/^ /,/^\./,/^:/,/^;/,/^,/,/^\*/,/^\//,/^-/,/^\+/,/^\^/,/^\(/,/^\)/,/^>/,/^</,/^>=/,/^<=/,/^<>/,/^NOT\b/,/^PI\b/,/^E\b/,/^"/,/^'/,/^$/,/^=/];return lexer;})()
parser.lexer = lexer;
return parser;
})();
